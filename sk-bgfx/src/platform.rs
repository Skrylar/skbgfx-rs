...
use self::libc::{c_void, uintptr_t, uint32_t, uint8_t, uint16_t};
...
extern "C" {
fn bgfx_render_frame(msecs: i32) -> render_frame;
fn bgfx_set_platform_data(data: *const PlatformData);
fn bgfx_get_internal_data() -> *const InternalData;
fn bgfx_override_internal_texture_ptr(handle: TextureHandle,
                                   ptr: uintptr_t) -> uintptr_t;
fn bgfx_override_internal_texture(handle: TextureHandle,
                               width: uint16_t,
                               height: uint16_t,
                               numMips: uint8_t,
                               format: TextureFormat,
                               flags: uint32_t) -> uintptr_t;
}
